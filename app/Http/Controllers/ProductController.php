...
class ProductController extends Controller
{
    ...
    public function show(Request $request, Product $product)
    {
        ...
        $productRecommend=categories::find($product->categories_id)->listProduct;
        $final=$productRecommend->except([$product->id]);

        return view('clients.products.productDetail', ['product' => $product,'productRecommend'=>$final,'user'=>$user]);
    }
    ...
    public function searchByName(Request $request)
    {
        ...
        if (count($products) > 0) {
            ...
            foreach ($products as $key) {
                ...
                // $output .= "<a href=http://banphimiq.test/products/show/$key->id>";
